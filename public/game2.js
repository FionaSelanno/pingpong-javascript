...
//     diff = -5;
  ...
  // if(this.bat.x < 0) {
  //   this.bat.x = 0;
  // } else if (this.bat.x + this.bat.width > 400) {
  //   this.bat.x = 400 - this.bat.width;
  // }
...
//   if(this.bat.y < 0) {
//     this.bat.y = 0;
//   } else if (this.bat.y + this.bat.height > 400) {
//     this.bat.y = 400 - this.bat.height;
//   }
};
